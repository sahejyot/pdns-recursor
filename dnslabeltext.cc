...
#line 1 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
#include <unistd.h>
...
#line 27 "librec-dnslabeltext.a.p/dnslabeltext.cc"
...
#line 30 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 93 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	cs = dnstext_start;
	}

#line 96 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 42 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{ 
                        ret.push_back(segment);
                        segment.clear();
                }
	break;
	case 1:
#line 46 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{ 
                        segment.clear();
                }
	break;
	case 2:
#line 50 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  char c = *p;
	...
	break;
	case 3:
#line 54 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  char c = *p;
                  val *= 10;
                  val += c-'0';
	...
	break;
	case 4:
#line 60 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
	...
	break;
	case 5:
#line 65 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  appendSplit(ret, segment, *(p));
                }
	break;
#line 204 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
...
#line 42 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	...
	break;
#line 225 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
	}
...
#line 78 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 243 "librec-dnslabeltext.a.p/dnslabeltext.cc"
...
#line 94 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 311 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	cs = dnsnameraw_start;
	}

#line 314 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 114 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{ 
                        if (labellen > 63) {
	...
	break;
	case 1:
#line 121 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{ 
                        lenpos=ret.size();
                        ret.append(1, (char)0);
                        labellen=0;
	...
	break;
	case 2:
#line 127 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  char c = *p;
                  ret.append(1, c);
                  labellen++;
	...
	break;
	case 3:
#line 132 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  char c = *p;
                  val *= 10;
                  val += c-'0';
	...
	break;
	case 4:
#line 137 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  ret.append(1, val);
                  labellen++;
                  val=0;
	...
	break;
	case 5:
#line 143 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
                  ret.append(1, *(p));
                  labellen++;
                }
	break;
#line 429 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
...
#line 137 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	...
	break;
#line 460 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
	}
...
#line 164 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 493 "librec-dnslabeltext.a.p/dnslabeltext.cc"
...
#line 557 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	cs = dns_text_to_string_start;
	}

#line 232 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 566 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 194 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    escaped_octet *= 10;
    escaped_octet += (*p)-'0';
    counter++;
	...
	break;
	case 1:
#line 200 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    val += escaped_octet;
    escaped_octet = 0;
  }
	break;
	case 2:
#line 205 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    val += (*p);
    counter++;
  }
	break;
	case 3:
#line 210 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    counter++;
  }
	break;
#line 663 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
...
#line 239 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 690 "librec-dnslabeltext.a.p/dnslabeltext.cc"
...
#line 739 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	cs = dns_text_to_value_list_start;
	}

#line 288 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
...
#line 748 "librec-dnslabeltext.a.p/dnslabeltext.cc"
	{
	int _klen;
	unsigned int _trans;
	const char *_acts;
...
_match:
	...
	while ( _nacts-- > 0 )
	{
		...
		{
	case 0:
#line 259 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    tmp += (*p);
    counter++;
  }
	break;
	case 1:
#line 264 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    tmp += (*p);
  }
	break;
	case 2:
#line 268 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    val.push_back(tmp);
    tmp.clear();
    counter++;
	...
	break;
	case 3:
#line 274 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	{
    counter++;
  }
	break;
#line 844 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
...
#line 268 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
	...
	break;
#line 866 "librec-dnslabeltext.a.p/dnslabeltext.cc"
		}
	}
	}
...
#line 295 "../../pdns-recursor/pdns/recursordist/./dnslabeltext.rl"
